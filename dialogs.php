...
<div id="dialog-sci-fac" title="Códigos de clientes a Facturar">
    <form>
        <div class="span5">
            <div class="row"><p class="validateTips"><strong>Complete los datos</strong></p></div>
            <div class="row">
            ...
            <div class="row">
                <div class="span2"><label>Código Vstour</label></div>
                <div class="span3"><input class="input" id="sci_fac_cli_cod" name="cli_cod" size="30"></div>
            </div>
            <div class="row">
                <div class="span2"><label>Código Vstour a Facturar</label></div>
                <div class="span3"><input class="input" id="sci_fac_cod" name="fac_cod" size="30"></div>
            </div>
        </div>
    </form>
</div>
...
<div id="dialog-sci-user" title="Acceso a documentación SCI">
    <form>
        <div class="span5">
            <div class="row"><p class="validateTips"><strong>Complete los datos</strong></p></div>
            <div class="row">
                <div class="span2"><label>Empresa</label></div>
                <div class="span3"><input class="input" id="sci_user_empresa" name="empresa" size="30"></div>
            </div>
            <div class="row">
                <div class="span2"><label>Usuario</label></div>
                <div class="span3"><input class="input" id="sci_user" name="user" size="30"></div>
            </div>
            <div class="row">
